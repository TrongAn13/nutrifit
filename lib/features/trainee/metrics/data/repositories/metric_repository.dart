...
class MetricRepository {
  ...
  /// Fetches all body metrics for the current trainee, ordered by date desc.
  ...
  ///
  /// Fetches the trainee's latest height or defaults to 170 cm.
  ...
  /// Fetches all progress photos for the current trainee, ordered by date desc.
