...
class NutritionRepository {
  ...
  /// Fetches user-created foods (isSystem == false, userId == current user).
  ...
  /// Adds a new user-created food to the `foods` collection.
  ...
  /// Fetches all nutrition plans belonging to the current user.
