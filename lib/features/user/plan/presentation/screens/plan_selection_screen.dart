...
import '../../../nutrition/presentation/screens/system_nutrition_library_screen.dart';
...
import '../../../workout/presentation/screens/system_plan_library_screen.dart';
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                children: [
                  // Banner 1: Workout plans - Navigate to System Library
                  _HeroBanner(
                    ...
                    onTap: () async {
                      await Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const SystemPlanLibraryScreen(),
                        ),
                      );
                      if (context.mounted) {
                  ...
                  _HeroBanner(
                    ...
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const SystemNutritionLibraryScreen(),
                        ),
                      );
                    },
                  ),
