...
4. TEXT HIỂN THỊ trên UI (Text widget, SnackBar, Dialog) BẮT BUỘC dùng Tiếng anh theo đúng mô tả của user.
...
4. UI/Design: Dùng Material 3 hoặc cupertino. Tách nhỏ các Widget dài. Hỗ trợ sẵn Dark/Light theme.
